...
contract Messenger is CCIPReceiver, OwnerIsCreator 
{
    ...
    address public usedTokensAddress; 
    ...
    constructor(address _router, address _link, address paramTokenAddressToUse) CCIPReceiver(_router) {
        linkToken = LinkTokenInterface(_link);
        usedTokensAddress = paramTokenAddressToUse;
    }
    ...
    */
    ...
    function mintErc20Tokens(uint paramTokensToMint) public 
    {
        iErc20(usedTokensAddress).mint(paramTokensToMint);
    }

    function transferErc20Tokens(address paramTo, uint paramQuantity) public 
    {
        iErc20(usedTokensAddress).transfer(paramTo, paramQuantity);
    }
